...
namespace TechMove.Services
{
    public class ApiService : IApiService
    {
        ...
        private  Task SetAuthorizationHeader()
        {
        ...
        public async Task<Client> CreateClientAsync(Client client)
        {
            ...
            try
            {
                ...
                _logger.LogInformation("Attempting to create client: {ClientJson}", clientJson);
                ...
                if (response.IsSuccessStatusCode)
                {
                    var createdClient = JsonSerializer.Deserialize<Client>(responseContent, new JsonSerializerOptions
                    {
                ...
                {
                    _logger.LogError("Failed to create client. Status: {StatusCode}, Error: {Error}",
                        response.StatusCode, responseContent);
                    return null;
                }
            }
            ...
            {
                _logger.LogError(ex, "Exception in CreateClientAsync");
                return null;
            }
        }
